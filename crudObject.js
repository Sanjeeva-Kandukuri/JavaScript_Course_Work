...
updatedStudent.greet();
outerFunction.call(updatedStudent);
outerFunction.apply(updatedStudent);
let value = outerFunction.bind(updatedStudent);       // apply = add, call = calling         bind= upadated student values perform
